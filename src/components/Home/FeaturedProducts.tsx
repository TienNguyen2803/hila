...
const sampleProducts: Product[] = [
  {
    ...
    description:
      'A blend of lavender, chamomile, and bergamot essential oils to promote relaxation.',
    imageUrl:
      'https://images.unsplash.com/photo-1600612253971-422e7f7faeb6?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80',
    price: 35.99,
    discountPrice: 29.99,
  },
  {
    ...
    imageUrl:
      'https://images.unsplash.com/photo-1570194065650-d99fb4de8b51?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80',
    price: 49.99,
  },
  {
    id: '3',
    ...
    description:
      'Luxurious body lotion with shea butter and almond oil for deep hydration.',
    imageUrl:
  ...
  },
  {
    ...
    description:
      'Collection of natural bath salts with different essential oils for a relaxing bath experience.',
    imageUrl:
      'https://images.unsplash.com/photo-1607006483224-85ca10a9343d?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80',
    price: 32.99,
  },
];
...
const products: Product[] = [
  {
    ...
    description:
      'Hydrating and rejuvenating face cream with natural ingredients.',
  ...
  },
  {
    ...
    name: 'Body Lotion',
    description:
      'Nourishing body lotion that leaves skin soft and moisturized.',
